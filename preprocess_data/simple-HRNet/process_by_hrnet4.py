    ...
    def process(self):
        ...
        for video_id, video_path  in tqdm(enumerate(video_paths)):
            ...
            if tmp == 2 or tmp == 3:
                ...
                output_sequence_dir1 = '/6T-3/fengyu/output/ntu_train'
            elif tmp == 1:
                output_sequence_dir = '/6T-3/fengyu/output/ntu_val'
                output_sequence_dir1 = '/6T-3/fengyu/output/ntu_val'
            output_sequence_path = '{}/{}.json'.format(output_sequence_dir, video_path)
            output_sequence_path1 = '{}/{}.json'.format(output_sequence_dir1, video_path)
            # debug
            ...
            if os.path.exists(output_sequence_path1):
                # ipdb.set_trace()
