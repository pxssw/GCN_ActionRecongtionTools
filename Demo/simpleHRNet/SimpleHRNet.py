...
class SimpleHRNet:
    ...
    def __init__(self,
                 ...
                 # yolo_model_def="simpleHRNet/models/detectors/yolo/config/yolov3-tiny.cfg",
                 ...
                 # yolo_weights_path="simpleHRNet/models/detectors/yolo/weights/yolov3-tiny.weights",
